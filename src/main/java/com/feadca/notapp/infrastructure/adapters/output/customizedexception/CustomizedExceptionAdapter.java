package com.feadca.notapp.infrastructure.adapters.output.customizedexception;

import com.feadca.notapp.domain.exception.UserNotFound;
import com.feadca.notapp.infrastructure.adapters.output.customizedexception.data.response.ExceptionResponse;
